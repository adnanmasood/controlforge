...
## Website Screenshot
- ![OWASP Top 10 for Large Language Model Applications official website screenshot](owasp-top10-llms.png)

## Brief Info
Reference checklist pack for OWASP Top 10 for Large Language Model Applications (v1.1). Jurisdiction: Global. Type: AppSec guidance.
